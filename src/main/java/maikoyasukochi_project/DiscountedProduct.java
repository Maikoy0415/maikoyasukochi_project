...
public class DiscountedProduct extends Product {
    ...
    public DiscountedProduct(int id, String name, int price, int stock, double discountRate, String category) {
        super(id, name, price, stock, category); // Pass category to the superclass constructor
